...
// Add to Selection
export const addItemsToSelection = (id, quantity) => async (dispatch, getState) => {
  ...
  localStorage.setItem("selectionItems", JSON.stringify(getState().selection.selectionItems));
};
