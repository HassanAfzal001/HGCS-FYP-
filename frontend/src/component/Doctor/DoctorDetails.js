...
import { NEW_REVIEW_RESET } from "../../constants/doctorConstants";
...
const DoctorDetails = ({ match }) => {
  ...
  const increaseQuantity = () => {
    if (doctor.Stock <= quantity) return;
  ...
  const reviewSubmitHandler = () => {
    ...
    myForm.set("doctorId", match.params.id);
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData title={`${doctor.name} -- HGCS`} />
          <div className="DoctorDetails">
            <div>
              <Carousel>
                {doctor.images &&
                  doctor.images.map((item, i) => (
                    <img
            ...
            <div>
              ...
              <div className="detailsBlock-3">
                ...
                <p>
                  Status:
                  <b className={doctor.Stock < 1 ? "redColor" : "greenColor"}>
                    {doctor.Stock < 1 ? "OutOfStock" : "InStock"}
                  </b>
                </p>
              </div>
          ...
          {doctor.reviews && doctor.reviews[0] ? (
